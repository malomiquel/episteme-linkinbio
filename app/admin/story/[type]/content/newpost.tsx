...
type Variant = "or" | "pourpre" | "nuit" | "vin" | "emeraude" | "saphir" | "ambre" | "rose" | "olive" | "lavande";
...
const THEMES: Record<Variant, Theme> = {
  or: {
    bg: "#2A1520",
    bgOverlay: "radial-gradient(ellipse at 50% 50%, transparent 30%, rgba(0,0,0,0.2) 100%)",
  ...
  emeraude: {
    ...
    frameBg: "linear-gradient(170deg, rgba(80,200,150,0.06) 0%, rgba(80,200,150,0.01) 100%)",
    glow1: "radial-gradient(ellipse at 50% 30%, rgba(16,90,70,0.6) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 20% 80%, rgba(80,200,150,0.1) 0%, transparent 45%)",
    glow3: "radial-gradient(ellipse at 75% 15%, rgba(40,120,90,0.25) 0%, transparent 40%)",
  ...
  saphir: {
    ...
    frameBg: "linear-gradient(170deg, rgba(70,130,220,0.06) 0%, rgba(70,130,220,0.01) 100%)",
    glow1: "radial-gradient(ellipse at 50% 35%, rgba(20,50,110,0.65) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 25% 10%, rgba(70,130,220,0.12) 0%, transparent 40%)",
    glow3: "radial-gradient(ellipse at 70% 85%, rgba(40,80,150,0.2) 0%, transparent 50%)",
  ...
  ambre: {
    ...
    frameBg: "linear-gradient(170deg, rgba(255,160,70,0.07) 0%, rgba(255,160,70,0.015) 100%)",
    glow1: "radial-gradient(ellipse at 50% 30%, rgba(140,70,20,0.6) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 30% 75%, rgba(255,160,70,0.1) 0%, transparent 45%)",
    glow3: "radial-gradient(ellipse at 75% 15%, rgba(200,100,30,0.2) 0%, transparent 40%)",
  ...
  rose: {
    ...
    frameBg: "linear-gradient(170deg, rgba(255,150,180,0.07) 0%, rgba(255,150,180,0.015) 100%)",
    glow1: "radial-gradient(ellipse at 50% 35%, rgba(140,50,80,0.6) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 25% 15%, rgba(255,150,180,0.1) 0%, transparent 40%)",
    glow3: "radial-gradient(ellipse at 70% 80%, rgba(200,80,120,0.2) 0%, transparent 50%)",
  ...
  olive: {
    ...
    frameBg: "linear-gradient(170deg, rgba(180,190,120,0.07) 0%, rgba(180,190,120,0.015) 100%)",
    glow1: "radial-gradient(ellipse at 50% 30%, rgba(80,85,50,0.65) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 30% 80%, rgba(180,190,120,0.08) 0%, transparent 45%)",
    glow3: "radial-gradient(ellipse at 75% 15%, rgba(120,130,70,0.2) 0%, transparent 40%)",
  ...
  lavande: {
    ...
    frameBg: "linear-gradient(170deg, rgba(180,150,230,0.07) 0%, rgba(180,150,230,0.015) 100%)",
    glow1: "radial-gradient(ellipse at 50% 35%, rgba(80,60,120,0.6) 0%, transparent 55%)",
    glow2: "radial-gradient(ellipse at 25% 75%, rgba(180,150,230,0.1) 0%, transparent 45%)",
    glow3: "radial-gradient(ellipse at 75% 15%, rgba(120,90,170,0.2) 0%, transparent 40%)",
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center w-full h-full px-14">
          ...
          {/* Caption */}
          <p
            className="font-(family-name:--font-playfair) text-[56px] font-bold leading-tight mt-12 text-center px-8"
            style={{ color: t.text }}
          >
            {caption}
          </p>
          ...
          <div className="flex items-center gap-5 mt-12 mb-12">
            <div className="w-[120px] h-px" style={{ background: t.ornament }} />
            <div
