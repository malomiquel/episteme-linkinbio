...
import { accordQuizConfig } from "../../../config/quiz-accords";

export const metadata: Metadata = {
  title: "Quel accord mets-vin es-tu ? | Episteme",
  description:
    "Découvre quel accord mets-vin te correspond le mieux avec notre quiz de personnalité !",
  openGraph: {
    title: "Quel accord mets-vin es-tu ? | Episteme",
    description:
      "Découvre quel accord mets-vin te correspond le mieux avec notre quiz de personnalité !",
...
export default function AccordsQuizPage() {
  return (
    <>
